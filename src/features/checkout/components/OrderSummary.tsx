...
interface OrderSummaryProps {
  totalPrice: number;
  onNext: (wantsInvoice: boolean) => void; // Logic: Boolean parametre eklendi
}
...
export function OrderSummary({ totalPrice, onNext }: OrderSummaryProps) {
  ...
  const [wantsInvoice, setWantsInvoice] = useState(false); // Logic: Fatura state'i
  ...
  // Logic: handlePaymentProcess tetiklendiğinde onNext'e wantsInvoice bilgisini gönderiyoruz
  const {
    isAuthOpen,
    setIsAuthOpen,
    isMobile,
