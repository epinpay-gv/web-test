...
export const DetailPageHeader = ({ order }: DetailPageHeaderProps) => {
  ...
  const copyButton = (
    <Button
      onClick={() => copyNumber(order.orderNumber, setCopied)}
      icon={
        copied ? (
  ...
  return (
    <div className="rounded-2xl bg-(--bg-neutral-primary-soft) p-2 flex flex-col gap-3">
      ...
      <div className="flex sm:hidden flex-col gap-3">
        ...
        {/* Sipariş durumu ve toplam tutar */}
