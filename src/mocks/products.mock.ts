...
export const mockProducts: ProductPageData[] = [
  {
    ...
    translation: {
      ...
      typeId: 1,
      locale: "tr",
      name: "Age of Empires-99 Apex Coins 10 Mythic Prisms - Battle.net Gift -North America Europe / North America America Europe / North America ",
...

  {
    ...
    translation: {
      ...
      metaDescription:
        "League of Legends 2.50 EUR Riot Points EU West | Epinpay",
      imgUrl:
...

  {
    ...
    translation: {
      ...
      metaDescription:
        "250 LoL RP (Riot Pin) TR | Uygun Fiyat ve Hızlı Teslimat",
      imgUrl:
